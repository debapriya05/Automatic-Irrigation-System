//----------------------------------Code Written by Deba Priya Manna ------------------------------
...
int moist_percent;
int rain_sensorReading;
int range;
const int rain_min=0;
const int rain_max=1024;
...
void loop(){
 ...
 rain_sensorReading = digitalRead(rain_sensor);
 //lcd.print(rain_sensorReading);
 //lcd.print("HELLO");
 range=rain_sensorReading;
 //range = map(rain_sensorReading, rain_min, rain_max, 0, 3);
...
SIM900.println("AT + CMGS = \"+919348219662\"");// recipient's mobile number
